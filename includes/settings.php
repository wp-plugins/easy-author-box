...
function ts_fab_initialize_plugin_options() {
	...
	add_settings_field(
		...
		'ts_fab_display_settings_section',
		array(
			__( 'Toggle displaying  Author Box in posts', 'ts-fab' )
		)
	);
	...
	add_settings_field(
		...
		'ts_fab_display_settings_section',
		array(
			__( 'Toggle displaying  Author Box in pages.', 'ts-fab' )
		)
	);
	...
	foreach ( $custom_post_types  as $custom_post_type ) {
		...
		add_settings_field(
			...
			'ts_fab_display_settings_section',
			array(
				__( 'Toggle displaying Author Box in ' . $custom_post_type_object->label . ' custom post type.', 'ts-fab' ),
				$custom_post_type
			)
		);
...
function ts_fab_display_settings_callback() { 
	...
	'<p>' . _e( 'Select where and how  Author Box appears in your posts, pages and custom posts.', 'ts-fab' ) . '</p>';
...
function ts_fab_show_settings_page() { ?>
	...
	<div class="wrap">
		...
		<h2>Easy Author Box Settings </h2>
		<p class="description"><?php _e( 'The easy author box display settings page', 'ts-fab' ); ?></p>
	</div>
