...
function ts_fab_show_latest_posts( $context = '', $authorid = '' ) {
	...
	<div class="ts-fab-tab" id="ts-fab-latest-posts-' . $context . '">
		...
		<div class="ts-fab-text">
			<div class="ts-fab-header">
				<h4>' . __( 'Latest posts by ', 'ts-fab' ) . $author->display_name . ' <span class="latest-see-all">(<a href="' . get_author_posts_url( $author->ID ) . '">' . __( 'Posts', 'ts-fab' ) . '</a>)</span></h4>
			</div>
...
function ts_fab_construct_fab( 
	...
	$ts_fab = '<div id="ts-fab-' . $context . '" class="ts-fab-wrapper">';
		...
		$ts_fab .= '<ul class="ts-fab-list">';
			...
			$ts_fab .= '<li class="ts-fab-bio-link"><a href="#ts-fab-bio-' . $context . '">' . __( 'Biography of the Author(Read Below)..', 'ts-fab' ) . '</a></li>';

			$ts_fab .= '<li class="ts-fab-latest-posts-link"><a href="#ts-fab-latest-posts-' . $context . '">' . __( 'Latest Posts (view them ).. ', 'ts-fab' ) . '</a></li>';
